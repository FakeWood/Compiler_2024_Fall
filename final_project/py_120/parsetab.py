...
_lr_productions = [
  ...
  ('PROGRAM -> STMT_LIST','PROGRAM',1,'p_program','final_yacc.py',141),
  ('STMT_LIST -> STMT','STMT_LIST',1,'p_stmt_list','final_yacc.py',145),
  ('STMT_LIST -> STMT STMT_LIST','STMT_LIST',2,'p_stmt_list','final_yacc.py',146),
  ('STMT -> EXP','STMT',1,'p_stmt','final_yacc.py',150),
  ('STMT -> DEF_STMT','STMT',1,'p_stmt','final_yacc.py',151),
  ('STMT -> PRINT_STMT','STMT',1,'p_stmt','final_yacc.py',152),
  ('PRINT_STMT -> LPAREN PRINT_NUM EXP RPAREN','PRINT_STMT',4,'p_print_stmt','final_yacc.py',156),
  ('PRINT_STMT -> LPAREN PRINT_BOOL EXP RPAREN','PRINT_STMT',4,'p_print_stmt','final_yacc.py',157),
  ('EXP -> BOOL_VAL','EXP',1,'p_exp','final_yacc.py',161),
  ('EXP -> NUMBER','EXP',1,'p_exp','final_yacc.py',162),
  ('EXP -> ID','EXP',1,'p_exp','final_yacc.py',163),
  ('EXP -> NUM_OP','EXP',1,'p_exp','final_yacc.py',164),
  ('EXP -> LOGICAL_OP','EXP',1,'p_exp','final_yacc.py',165),
  ('EXP -> FUN_EXP','EXP',1,'p_exp','final_yacc.py',166),
  ('EXP -> FUN_CALL','EXP',1,'p_exp','final_yacc.py',167),
  ('EXP -> IF_EXP','EXP',1,'p_exp','final_yacc.py',168),
  ('NUM_OP -> LPAREN PLUS EXP EXP_LIST RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',172),
  ('NUM_OP -> LPAREN MINUS EXP EXP RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',173),
  ('NUM_OP -> LPAREN MULTIPLY EXP EXP_LIST RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',174),
  ('NUM_OP -> LPAREN DIVIDE EXP EXP RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',175),
  ('NUM_OP -> LPAREN MODULUS EXP EXP RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',176),
  ('NUM_OP -> LPAREN GREATER EXP EXP RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',177),
  ('NUM_OP -> LPAREN SMALLER EXP EXP RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',178),
  ('NUM_OP -> LPAREN EQUAL EXP EXP_LIST RPAREN','NUM_OP',5,'p_num_op','final_yacc.py',179),
  ('EXP_LIST -> EXP','EXP_LIST',1,'p_exp_list','final_yacc.py',186),
  ('EXP_LIST -> EXP EXP_LIST','EXP_LIST',2,'p_exp_list','final_yacc.py',187),
  ('LOGICAL_OP -> LPAREN AND EXP EXP_LIST RPAREN','LOGICAL_OP',5,'p_logical_op','final_yacc.py',192),
  ('LOGICAL_OP -> LPAREN OR EXP EXP_LIST RPAREN','LOGICAL_OP',5,'p_logical_op','final_yacc.py',193),
  ('LOGICAL_OP -> LPAREN NOT EXP RPAREN','LOGICAL_OP',4,'p_logical_op','final_yacc.py',194),
  ('DEF_STMT -> LPAREN DEFINE ID EXP RPAREN','DEF_STMT',5,'p_def_stmt','final_yacc.py',203),
  ('FUN_EXP -> LPAREN FUN LPAREN FUN_IDS RPAREN FUN_BODY RPAREN','FUN_EXP',7,'p_fun_exp','final_yacc.py',209),
  ('FUN_IDS -> <empty>','FUN_IDS',0,'p_fun_ids','final_yacc.py',214),
  ('FUN_IDS -> ID FUN_IDS','FUN_IDS',2,'p_fun_ids','final_yacc.py',215),
  ('FUN_BODY -> EXP','FUN_BODY',1,'p_fun_body','final_yacc.py',223),
  ('FUN_BODY -> DEF_STMT EXP','FUN_BODY',2,'p_fun_body','final_yacc.py',224),
  ('FUN_CALL -> LPAREN FUN_EXP PARAM_LIST RPAREN','FUN_CALL',4,'p_fun_call','final_yacc.py',229),
  ('FUN_CALL -> LPAREN ID PARAM_LIST RPAREN','FUN_CALL',4,'p_fun_call','final_yacc.py',230),
  ('PARAM_LIST -> <empty>','PARAM_LIST',0,'p_param_list','final_yacc.py',238),
  ('PARAM_LIST -> PARAM PARAM_LIST','PARAM_LIST',2,'p_param_list','final_yacc.py',239),
  ('PARAM -> EXP','PARAM',1,'p_param','final_yacc.py',247),
  ('IF_EXP -> LPAREN IF EXP EXP EXP RPAREN','IF_EXP',6,'p_if_exp','final_yacc.py',252),
]
